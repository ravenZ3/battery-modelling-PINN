...
def main():
    args = get_args()
    for e in range(10):
        setattr(args, 'save_folder', f'results/MIT results/Experiment{e + 1}')
...
def small_sample():
    ...
    num_battery = 2
    for e in range(10):
        setattr(args, 'save_folder', f'results/MIT results (small sample {num_battery})/Experiment{e + 1}')
